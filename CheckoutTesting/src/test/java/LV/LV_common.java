...
public class LV_common {

public static void LV_fillingForm() {
	  ...
	  driver.findElement(By.id("billing_phone")).sendKeys("+37126620003");
	  driver.findElement(By.id("billing_city")).sendKeys("Sipron");
	  driver.findElement(By.id("billing_address_1")).sendKeys("1021");
	  driver.findElement(By.id("billing_postcode")).sendKeys("1021");
