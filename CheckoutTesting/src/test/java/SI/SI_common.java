...
public class SI_common {

public static void SI_fillingForm() {
	  ...
	  driver.findElement(By.id("billing_phone")).sendKeys("+38651637635");
	  driver.findElement(By.id("billing_city")).sendKeys("Sipron");
	  driver.findElement(By.id("billing_address_1")).sendKeys("2390");
	  driver.findElement(By.id("billing_postcode")).sendKeys("2390");
